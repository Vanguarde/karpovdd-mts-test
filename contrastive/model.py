...
from transformers import BertPreTrainedModel, RobertaModel, BertModel, DistilBertModel
...
class DistilBertForSequenceClassification(nn.Module):
    ...
    def forward(
        ...
        pooled_output = pooled = outputs.last_hidden_state[:,0]
